        ...
        if sudo2(m):
            try:
                ...
                if lang is None:
                    ...
                    t = "\n◍ قائمة المطورين \n≪━━━━━━━━@Source_Harp━━━━━≫\n" + f"◍ [𝑴𝑨𝑹𝑪𝑬𝑳𝑶](tg://user?id={super_sudoers[0]})\n" + f"◍ [{n.first_name}](tg://user?id={sudoers[0]})\n\n√"
                    for row in lang:
...
########################################################################################################################
    ...
    if m.text == "السورس" or m.text == "سورس" or m.text == "يا سورس":
        ...
        await m.reply_text("""
╭──── • ◈ • ────╮
么 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗵𝗲𝗼](t.me/Source_ Harp)
么 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗕𝗼𝘁](t.me/Source_Harp2_bot)
...
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼
    ...
    if m.text == "حرب" or m.text == "حرب":
        ...
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(f"{s.first_name}", user_id=7082813679)],
        ])
        try:
    ...
    if m.text == (get_db_botname() or "حرب"):
        texting = ["اؤمر " + (get_db_botname() or "حرب") + " شتريد؟❤️🥺",
                   ...
                   "قلبى بينادى على " + (get_db_botname() or "حرب1") + "😘",
                   "نعسان محدش يصحينى🙄"
                   ]
