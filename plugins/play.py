...
async def gen_thumb(videoid):
    ...
    try:
        ...
        return f"https://graph.org/file/d2bac4be67ff8fb6b17c5.jpg"
...
async def play(client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𖤐↜𝑪𝑯 𝑺𝑶𝑼𝑹𝑪𝑬↝𖤐", url=f"https://t.me/Source_Harp")],
...
🎧 **بواسطه:** {ruser}
        ...
        try:
            ...
            if 'CreateGroupCall' in str(e):
                ...
                return await dream.edit_text(f"{e}\n◍ في حاله ظهور لك مثل هذه المشكله تواصل مع المطور -> @H_A_R_P_M")
    ...
    if admin(msg):
        ...
        if command == "/pause":
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                ...
                [InlineKeyboardButton("𖤐↜𝑪𝑯 𝑺𝑶𝑼𝑹𝑪𝑬↝𖤐", url="https://t.me/Source_Harp")],
